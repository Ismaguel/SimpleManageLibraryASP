...
namespace Lib.Web.Migrations
{
    ...
    [Migration("20230908180736_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lib.Web.Models.Imprint", b =>
                {
                    b.HasOne("Lib.Web.Models.Book", "Book")
                        .WithMany()
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Lib.Web.Models.Imprinter", "Emprinteur")
                        .WithMany("Imprints")
                        .HasForeignKey("EmprinteurId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
